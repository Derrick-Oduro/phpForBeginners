        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="<?php echo urlIs('/') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
              <a href="/about" class="<?php echo urlIs('/about') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">About</a>
              <a href="/notes" class="<?php echo urlIs('/notes') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Notes</a>
              <a href="/contact" class="<?php echo urlIs('/contact') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Contact</a>
